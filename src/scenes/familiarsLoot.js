...
familiarsLoot.hears(actions.FAMILIARS_LOOT_FOURTH, (ctx) => {
  ctx.replyWithHTML(
    '<b>Пакт 4</b>\n' +
    '\n' +
    '<b>Саблезуб</b> - крайне важный фамильяр на всех стадиях игры. Серия охот позволит убить 4-5 моба без серьезных затрат по энергии. Экономия энергии очень существенна, поэтому качать при первой возможности.\n' +
    ...
    'Чем сильнее фам, тем больше экономим энергии и тем быстрее убиваем моба. Неоценима помощь игрока с саблезубом и энкой на ПГ.\n' +
    '\n' +
