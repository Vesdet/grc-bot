...
familiars.hears(actions.EQUIPMENT_INFANTRY, (ctx) => {
  ctx.replyWithHTML(
    ...
    '\n' +
    '- <b>Гремлин</b> - пакт 3 (Увеличивает АТК пехоты на 100%, когда 10% вашей пехоты падет. Эффект накладывается; неообходимое количество павших солдат бкдет пересчитываться после каждой активации)\n' +
    '\n' +
...
familiars.hears(actions.EQUIPMENT_RANGED, (ctx) => {
  ctx.replyWithHTML(
    ...
    '\n' +
    '- <b>Патрик</b> - пакт 3 (Увеличивает АТК стрелков на 100%, когда 10% ваших стрелков падет. Эффект накладывается; неообходимое количество павших солдат бкдет пересчитываться после каждой активации)\n' +
    '\n' +
    '- <b>Штормовит</b> - пакт 2А (Оглушает один из наибольших вражеских отрядов на 8 секунд, когда 10% ваших солдат падут)\n' +
    '\n' +
...
familiars.hears(actions.EQUIPMENT_CAVALRY, (ctx) => {
  ctx.replyWithHTML(
    ...
    '\n' +
    '- <b>Гоблин</b> - пакт 3 (Увеличивает АТК кавалерии на 100%, когда 10% вашей кавалерии падет. Эффект накладывается; неообходимое количество павших солдат бкдет пересчитываться после каждой активации)\n' +
    '\n' +
    '- <b>Магот</b> - пакт 4 (Оглушает всех вражеских Героев на 5 секунд, когда 15% ваших войск падут)\n' +
    '\n' +
    '- <b>Грифон</b> - пакт 3 (Увеличивает 1 раз за бой АТК армии на 200% на 10 сек, когда 10% войск пало)' +
